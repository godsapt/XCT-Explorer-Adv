...
with tabCitation:
    ...
    st.write ('If you find XCT-explorer useful for the planning of your experiment please cite the publication :blue[?? TMS 2024]. The advanced features were not peer-reviewed') 
